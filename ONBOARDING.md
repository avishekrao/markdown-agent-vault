---
id: markdown-agent-vault-onboarding
type: guide
status: active
created: 2026-05-02
updated: 2026-05-02
...
This guide helps you start using the vault: open the folder in an agent, run one safe task, store the result in the right place, check links, and slowly turn repeated work into rules and templates.
...
4. Use the final checklist before trusting the result.
...
```text
Open this folder as my working vault. First read AGENTS.md, START_HERE.md, and ONBOARDING.md. Explain the folder structure and the main rules in plain language. Then suggest one safe first test.
```
...
- `START_HERE.md` - short first entry.
- `ONBOARDING.md` - full onboarding route.

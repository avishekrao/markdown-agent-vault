...
```text
Open this folder as my working vault. First read AGENTS.md, START_HERE.md, QUICKSTART.md, and ONBOARDING.md. Explain the folder structure in plain language. Then help me run one safe test: route a small note from 00_inbox/ into a new project, update links, and write a log entry.
```
